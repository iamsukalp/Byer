...
import com.byer.byerretailer.databinding.FragmentLoginBinding;
...
public class LoginFragment extends Fragment {
                ...
                user.getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
                    ...
                    public void onComplete(@NonNull Task<GetTokenResult> task) {
                                if (task.isSuccessful()){
                                    ...
                                    LoginFragmentDirections.ActionLoginFragmentToRetailerDetailsFragment action = LoginFragmentDirections.actionLoginFragmentToRetailerDetailsFragment();
    ...
    private void updateUI(FirebaseUser user, String token) {
        if(user!=null){
           // TODO: add details fragment here
            LoginFragmentDirections.ActionLoginFragmentToRetailerDetailsFragment action = LoginFragmentDirections.actionLoginFragmentToRetailerDetailsFragment();
            action.setPhone(phone);
            action.setToken(token);
            Navigation.findNavController(binding.getRoot()).navigate(action);
