...
import com.byer.byerretailer.databinding.FragmentSignUpBinding;
...
public class SignUpFragment extends Fragment {
                ...
                user.getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
                    ...
                    public void onComplete(@NonNull Task<GetTokenResult> task) {
                        if (task.isSuccessful()){
                            ...
                            SignUpFragmentDirections.ActionSignUpFragmentToRetailerDetailsFragment action=SignUpFragmentDirections.actionSignUpFragmentToRetailerDetailsFragment();
    ...
    private boolean Validate() {
        ...
        if (TextUtils.isEmpty(binding.signupPhone.getText().toString())){
            isValid=false;
        }
        else{
